...
// ---------- Student dashboard: list all assignments with status ----------
...
// ---------- View a single assignment + submission form ----------
...
router.post('/assignment/:id/submit', requireRole('student'), (req, res) => {
  upload.single('file')(req, res, async (err) => {
    try {
      ...
      // Update existing submission or create a new one (one submission per student per assignment)
